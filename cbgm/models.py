...
class Cbgm_Db(models.Model):
    ...
    threshold = models.SmallIntegerField(
        default=1, help_text="Minimum number of readings for a witness to be included."
    )
    trivial_types = models.CharField(
        max_length=255,
        null=True,
        blank=True,
        help_text='List of reading types to treat as agreeing with their parent. E.g., "subr err"',
    )
    ignore_types = models.CharField(
        max_length=255,
        null=True,
        blank=True,
        help_text='List of reading types to ignore. E.g., "lac defi"',
    )
    ignore_suffixes = models.CharField(
        max_length=255,
        null=True,
        blank=True,
        help_text='List of witness suffixes to strip away. E.g., "* T V"',
    )
    ...
    remove_rdg_types_before_import = models.JSONField(null=True, default=list)
