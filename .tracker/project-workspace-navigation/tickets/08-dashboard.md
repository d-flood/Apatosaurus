...
Removing eager Default creation from the dev Reset-DB handler (in addition to worker startup) is accepted as consistent with the authorized lazy-Default deviation.
