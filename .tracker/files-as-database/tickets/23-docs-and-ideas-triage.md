# Ticket 23: Documentation and Ideas Triage

Architecture reference: `../architecture.md` (all); this epic's `SPEC.md`
...
2. **About/onboarding pages**: finalize the ticket 16 draft content — recommended setup, data-ownership statement (where files live; how to leave the app with your data: sync folder or zip; every transcription and collation has a TEI sibling).
...
- Ticket 16's about content — finalize, don't duplicate.
...
- Contributor docs are verified executable: adding-a-format-version instructions must match what the ticket 22 upgrade scenario actually did.
