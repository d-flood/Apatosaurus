...
urls = [
    ...
    path('<int:collation_pk>/download-tei', views.download_tei_collation, name='download-tei-collation'),
    path('<slug:collation_slug>/analyze/', views.analyze_collation, name='analyze-collation'),

    path('<slug:collation_slug>/filter-variants/', views.filter_variants, name='filter-variants'),
    ...
    path('collation_slug/<int:section_id>/upload-tei/', views.upload_tei_collation, name='upload-tei'),
    path('collation_slug/<int:section_pk>/download-tei', views.download_tei_section, name='download-tei-section'),
    path('collation_slug/<int:section_id>/edit/', views.edit_section, name='edit-section'), # TODO: use actual slugs
    ...
    path('collation_slug/section_slug/<int:ab_pk>/edit/', views.edit_ab, name='edit-ab'),
    ...
    path('collation_slug/section_slug/ab_slug/<int:app_pk>/rdg/cancel/', views.cancel_new_rdg, name='cancel-new-rdg'),
    path('collation_slug/section_slug/ab_slug/app_slug/<int:rdg_pk>/note/', views.reading_note, name='reading-note'),
    path('collation_slug/section_slug/ab_slug/<int:app_pk>/<int:delete>/edit-arc/', views.edit_arc, name='edit-arc'),
    path('collation_slug/section_slug/ab_slug/app_slug/<int:rdg_pk>/history/', views.rdg_history, name='rdg-history'),
    path('collation_slug/section_slug/ab_slug/app_slug/<int:rdg_pk>/<int:history_pk>/restore/', views.restore_rdg, name='restore-rdg'),
]