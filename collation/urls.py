...
urls = [
    ...
    path('analyze/<slug:collation_slug>/', views.analyze_collation, name='analyze-collation'),
    path('analyze/<slug:collation_slug>/filter-variants/', views.filter_variants, name='filter-variants'),
    ...
    path('<slug:collation_slug>/<str:section_slugname>/<str:ab_slugname>/<str:app_slugname>/', views.rdgs, name='rdgs'),
